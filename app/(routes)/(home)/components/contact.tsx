...
const style: any = {
  "--glass-bg": "hsla(0, 0%, 49%, .1)",
  "--glass-shadow": "hsla(240, 5%, 15%, .08)",
  "--glass-border": "hsla(240, 5%, 85%, .3)",
};
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12" style={style}>
          <div className="space-y-8">
            <div className="glass-card p-8 rounded-2xl">
              ...
              <div className="space-y-6">
                <a href="mailto:abdulahad.devmail@gmail.com" target="_blank">
                  <div className="flex items-start p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-all duration-200 group mb-2">
                ...
                <a
                  href="https://www.upwork.com/freelancers/~019d8faa90a00bafcb"
                  target="_blank"
                >
                  <div className="flex items-start p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-all duration-200 group mb-2">
                    <div className="p-3 rounded-lg bg-muted text-foreground group-hover:bg-muted/80 transition-colors duration-200 shrink-0">
            ...
            <div className="glass-card p-6 rounded-2xl">
              ...
              <p className="text-sm text-foreground/60 mt-2">
                Focused on existing projects, but feel free to reach out for
